...
class Bd{
    ...
    recuperarTodosRegistros(){
        ...
        //recuperar todas as despesas cadastrars em localStarage
        for(let i = 1; i <= id; i++){
            //recuperar a despesa
...
function cadastrarDespesa(){
    ...
    if (despesa.validarDados()){
        ...
        document.getElementById('modal_conteudo').innerHTML = 'despesa foi inserida com sucesso'
...
function carregaListaDespesas(despesas = Array(), filtro = false){
    ...
    //percorrer o array desdesas, listando cada despesa
    //de forma dinamina
    despesas.forEach(function(d){
        ...
        d.dia = 28
        //criar as colunas (td)
        linha.insertCell(0).innerHTML = `${d.ano}/${d.mes}/${d.ano}`
        //ajustar o tipo 
        switch(d.tipo){
